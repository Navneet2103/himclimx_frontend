      ...
      <AnimatePresence>
        {!sidebarOpen && (
          <motion.button
            ...
            className="fixed left-0 top-1/2 -translate-y-1/2 mt-8 z-50 p-2 bg-white dark:bg-slate-800 rounded-r-lg shadow-lg border border-l-0 border-slate-200 dark:border-slate-700"
          >
